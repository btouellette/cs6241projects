...
namespace
{
  ...
  public:
    ...
    //Analyzes a particular operand in a basic block to check its monotonic 
    //properties
    //Implementation: Retrieve each occurence of the operand idx in the basic
    //block and check if there is a constant increase/decrease/multiplication
	...
	!I->getName().str().compare(0, 12, "_arrayref lb"))
        {
          cgen.insert(&(*(--I)));
          cgen.insert(&(*(++I)));
        }
